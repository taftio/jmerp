 ...
 * @version 1.0
 */
public class BirthDoneCard extends AbstractCharGenWizPanel {
    /**
    ...
    public void buildCard(MerpCharacter mChar) {
        ...
        JTextArea heading = new JTextArea("Your birth portion is done");
    ...
    public String getDescription() {
        return "Congratulations!  You've finished the first portion of "
