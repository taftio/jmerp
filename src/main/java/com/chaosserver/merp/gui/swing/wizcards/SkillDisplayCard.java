...
public class SkillDisplayCard extends AbstractCharGenWizPanel {
    /** This is the panel being represented */
    private SkillListPanel m_skillListPanel;

    /**
     * Setter for the race selector panel
     *
     * @param SkillListPanel The new panel value
     */
    private void setSkillListPanel(SkillListPanel skillListPanel) {
        m_skillListPanel = skillListPanel;
    }
     ...
     * @return The panel
     */
    public SkillListPanel getSkillListPanel() {
        return m_skillListPanel;
    }
